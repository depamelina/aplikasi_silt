				...
				<div class="row">
					<div class="col-xl-12">
									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<button class="btn btn-<?= $btn ?> btn-sm" onclick="return btn_nilai(`<?= $b->id_buku ?>`,`<?= $b->judul ?>`,`<?= $b->nilai_plus ?>`,`<?= $b->nilai_isi ?>`)">
														<?= $btn_text ?> 
												</button>
												</td>
											</tr>
						...
						<div class="row">
							...
							<a href="<?= base_url().ucfirst($this->session->userdata('level')) ?>/NilaiResume" class="btn btn-dark legitRipple">Kembali <i class="icon-arrow-left52 ml-2"></i></a>
							</div>
						</div>				
					</div>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<span id="modal-body-update-or-create">
							...
							<div class="form-group">
								<label>Nilai Struktur dan Bahasa</label>
