	...
	<script src="<?= base_url() ?>template/global_assets/js/plugins/editors/ckeditor/ckeditor.js"></script>
	<script src="<?= base_url() ?>template/global_assets/js/demo_pages/editor_ckeditor.js"></script>
